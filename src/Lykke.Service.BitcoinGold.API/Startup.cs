...
using Lykke.Service.BitcoinGold.API.Middleware;
using Lykke.Service.BitcoinGold.API.Modules;
...
namespace Lykke.Service.BitcoinGold.API
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                {
                    options.DefaultLykkeConfiguration("v1", "BitcoinGold API");
                });
